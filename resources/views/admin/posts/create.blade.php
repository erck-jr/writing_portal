                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="editor" name="content" required 
                                      ...
                                      placeholder="Mulai tulis ceritamu di sini...">{{ old('content') }}</textarea>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <label class="flex-1 cursor-pointer group">
                                    <input type="radio" name="status" value="draft" class="hidden peer" {{ old('status', 'draft') === 'draft' ? 'checked' : '' }}>
                            ...
                            <div class="mt-3">
                                <label class="flex items-center gap-2 cursor-pointer p-3 bg-gray-50 dark:bg-gray-800 rounded-xl hover:bg-yellow-50 dark:hover:bg-yellow-900/10 transition-colors border-2 border-transparent peer-checked:border-yellow-200">
                                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="rounded border-gray-300 text-yellow-500 focus:ring-yellow-500">
